...
# df = pd.DataFrame({
#     "Miesiac": ["Styczeń", "Luty", "Marzec", "Kwiecień", "Maj", "Czerwiec"],
#     "Sprzedaz": [1200, 1500, 1700, 1600, 2100, 2300],
...
# st.write("### Dane sprzedazy")
# st.dataframe(df)
#
# # Wykres liniowy
# st.write("### Wykres sprzedazy")
# st.line_chart(df, x="Miesiac", y="Sprzedaz")
#
# # Widget interaktywny
